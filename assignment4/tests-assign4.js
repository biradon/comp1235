...
describe('fetchProducts()', () =>  {
    it('This asyn/wait function fetchs products from the dummy json products api',  async () => {
        expect(await fetchProducts(1)).to.deep.equal("iPhone 9");
        expect(await fetchProducts(12)).to.deep.equal("Brown Perfume");
        expect(await fetchProducts(50)).to.deep.equal("Women Shoes");
